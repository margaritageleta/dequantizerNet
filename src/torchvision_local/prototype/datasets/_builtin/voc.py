...
from torchvision_local.prototype.datasets.utils import OnlineResource, HttpResource, Dataset
...
from torchvision_local.prototype.features import BoundingBox, Label, EncodedImage
