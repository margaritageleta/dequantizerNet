...
from torchvision_local import datasets as legacy_datasets
from torchvision_local.datasets.utils import extract_archive
from torchvision_local.prototype import datasets as new_datasets
from torchvision_local.transforms import PILToTensor
